"""SQLite persistence for Playlist Assistant Historical Test application settings and status.
...
class ApplicationStorage:
    ...
    def get_target_playlist(self) -> tuple[str, str | None]:
        ...
        return values.get("target_playlist_name", "Playlist Assistant Historical Test"), values.get("target_playlist_id")
