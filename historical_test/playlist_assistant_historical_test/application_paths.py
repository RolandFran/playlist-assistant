"""Persistent runtime paths for the Playlist Assistant Historical Test engine.
...
class ApplicationPaths:
    """Locations owned by Playlist Assistant Historical Test's persistent runtime data."""
    ...
    def database_path(self) -> Path:
        return self.data_dir / "playlist_assistant_historical_test.db"
