"""Push-updated bridge state for Playlist Assistant Historical Test entities."""
...
class PlaylistAssistantCoordinator(DataUpdateCoordinator):
    def __init__(self, hass, bridge=None, spotify: SpotifyApi | None = None, entry=None):
        ...
        self.entry = entry
        super().__init__(hass, logger=logging.getLogger(__name__), name="playlist_assistant_historical_test", update_method=self._async_update_data)
