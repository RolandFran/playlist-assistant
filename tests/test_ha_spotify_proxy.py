...
class ProxyClientTests(unittest.TestCase):
    ...
    def test_operations_are_mapped_without_spotify_credentials(self):
        ...
        self.assertEqual([item["operation"] for item in requests], ["recently_played", "user_playlists", "playlist_items", "create_playlist", "playlist_details", "playlist_details", "replace_items"])
        ...
        self.assertEqual(requests[4]["json"], {"name": "Today"})
        self.assertEqual(requests[5]["json"], {"public": False})
